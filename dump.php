...
<table border="0">
  ...
  <tr>
    ...
    <td><input  name="mysql_database" value="mynuvotv_db"  /></td>
  ...
  <tr>
    ...
    <td><input  name="mysql_username" value="root"  /></td>
  ...
  <tr>
    ...
    <td><input  type="password" name="mysql_password" value="ourlady"  /></td>
...
<input type="submit" name="action"  value="Test Connection"><br />
  ...
  <tr>
    ...
    <td><input  type="input" name="mysql_table" value="<?php if( isset($_REQUEST['mysql_table']) )echo $_REQUEST['mysql_table']; ?>"  /></td>
