	                    ...
	                    <tbody> \
	                      ...
	                      <tr> \
	                        ...
	                        <td class="mm" style="background:#fff; vertical-align:top; padding:10px;"> \
					                  <a href="#" title="Close" id="zoom_close" style="z-index:1;height:5px;float:right;position:relative; left:7px;top:-5px;"> \
					                    <img  src="' + directory + '/closebox.' + ext + '" alt="Close" style=" margin:0; padding:0;" /> \
					                  </a> \
	                          <div <?php  if( $this->tools->browserIsExplorer()){ 
	                          									echo 'style="position:relative; top:-22px;"';   
	                          						};
...
/*	  	
	  		...
	  		if( window.parent.document.getElementById('bottom_edit_frame')  ){
	  			window.parent.bottom_edit_frame.$(".embed_video").css({visibility:'visible'}); 
	  		};
