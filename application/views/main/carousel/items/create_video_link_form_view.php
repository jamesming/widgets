...
<body >
<div   class='header ' >VIDEO HOTSPOT<br />
</div>
<div  class='input_div ' >
Link&nbsp;&nbsp;<input name="video_link" id="video_link" type="text" value="<?php echo $data['carousel_items_images'][0]->video_link    ?>">
</div>
...
<script type="text/javascript" language="Javascript">
	...
	$(document).ready(function() {
							...
							jQuery('#cropbox').Jcrop({		
								...
								aspectRatio: 0,
//								setSelect:   [<?php echo $data['carousel_items_images'][0]->video_top   ?>,  <?php echo $data['carousel_items_images'][0]->video_left   ?> ,<?php echo $data['carousel_items_images'][0]->video_width   ?>, <?php echo $data['carousel_items_images'][0]->video_height   ?>]
								setSelect:   [<?php echo $data['carousel_items_images'][0]->video_left   ?>,<?php echo $data['carousel_items_images'][0]->video_top   ?>,<?php echo $data['carousel_items_images'][0]->video_left + $data['carousel_items_images'][0]->video_width   ?>,<?php echo $data['carousel_items_images'][0]->video_top + $data['carousel_items_images'][0]->video_height   ?>]
